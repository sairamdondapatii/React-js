...
const Hero = () => {
  return (
    <div className='grid grid-cols-1 lg:grid-cols-2 p-16 gap-11'>
        <div>
        ...
        <div className="carousel carousel-center h-[25rem] space-x-4  rounded-box">
            {curoselImages.map((image,index)=>{
                return(
                    <div key={image} className="carousel-item">
                        <img src={image} className='rounded-box h-full object-cover w-72'/>
                    </div>
                )
            })}
        </div>
